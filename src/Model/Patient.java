...
public class Patient extends HospitalUser implements Serializable,Comparable<Patient>{
	...
	/**
	 * a setter of status, if the value is above 100 or negative threre is exception to handle
	 * @param status
	 * @return string
	 */
