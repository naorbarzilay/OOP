...
public class Department implements Serializable {
	...
	public String toString() {
		return "Department : " + deptName + ", spec=" + spec + "]";
	}
	/**
	 * a method that adds a subdepartment to subdepartment data structure and to the Hospital
	 * @param subDepartment
	 * @return true/false
	 */
	public boolean addSubDepartment(SubDepartment s) {
		if (getSdepts().contains(s) ||
				Hospital.getInstance().getRealSubDepartment(s.getId()) != null)
			return false;
		else {
			getSdepts().add(s);
	...
	/**
	 * a method that tries to delete a subdepartment, if its not empty it will transfer the sub
	 * to another sub
	...
	/**
	 * a method that transfers a subdepartment data structures to another subdepartment
	 * @param from
	 * @param to
	 */
